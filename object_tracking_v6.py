...
test_1_csv_path = "test_1.csv"


# # Shu's path
# test_1_txt_filename = "G:/9517GroupProject/txt_files/final/test_1.txt"    # path of the txt file
# test_1_jpg_dir = "G:/9517GroupProject/step_images/test/STEP-ICCV21-01/" # path of dir of test 1 images
# test_1_out_dir = "G:/9517GroupProject/output/output_images/test_1/" # output image directory
# test_1_csv_path = "G:/9517GroupProject/output/output_csv/test_1.csv"

# test_2_txt_filename = "G:/9517GroupProject/txt_files/final/test_2.txt"
# test_2_jpg_dir = "G:/9517GroupProject/step_images/test/STEP-ICCV21-07/" # path of dir of test 2 images
# test_2_out_dir = "G:/9517GroupProject/output/output_images/test_2/" 
# test_2_csv_path = "G:/9517GroupProject/output/output_csv/test_2.csv"
    ...
    while frame < n_frames:
        ...
        while id < n_ids:
            if id_tracks[id][frame].all() != 0 and id_tracks[id][frame][0] != -1:
                ...
                #cv2.putText(img, str(id), (center_x, center_y - height//2), 0, 1, colours[id], 2)
                
                # also draw the track lines
                if frame >= 2: # because no track in the first 2 frames
                    curr_frame = frame
                    prev_frame = curr_frame - 1
                    # if == 0, then it have reached the start
                    # if == -1, then it reached a gap that we decide not to fill
                    # so stop when == 0 or == 1
                    while ((id_tracks[id][prev_frame].all() != 0 and id_tracks[id][prev_frame][0] != -1)
                        ...
                        #print(center_x_curr, center_x_prev)
        ...
        # print(frame)
        #print(prev_groups)
        #print(gorup_info_prev_frame)
        analyses.group_analyses(colours, img, gorup_info_curr_frame, gorup_info_prev_frame, prev_ppl, curr_ppl, curr_groups, prev_groups)
...
def view(test_out_dir, id_track):
...
# make output images
print("========== Start making output images ==============")
all_label_1, n_person_1, id_tracks = detect_and_tracks(test_1_txt_filename, test_1_jpg_dir, test_1_out_dir)
print("Finish making output images for test 1")
# all_label_2, n_person_2 = detect_and_tracks(test_2_txt_filename, test_2_jpg_dir, test_2_out_dir)
print("Finish making output images for test 2")

# make csv files
print("\n========== Start making output csv files ==============")
...
view(test_1_out_dir, id_tracks)

# make videos from output images
# print("\n========== Start making output videos ============== ")
# video_in_1 = "G:/9517GroupProject/output/output_images/test_1/"
# video_in_2 = "G:/9517GroupProject/output/output_images/test_2/"
# video_out_1 = "G:/9517GroupProject/output/output_videos/test_1_output.mp4"
# video_out_2 = "G:/9517GroupProject/output/output_videos/test_2_output.mp4"

#Comment out if not used

# jpg_to_mp4(video_in_1, video_out_1)
# print("Finish making output video for test 1")
# jpg_to_mp4(video_in_2, video_out_2)
# print("Finish making output video for test 2")
